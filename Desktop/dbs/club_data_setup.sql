...
insert into facilities (id, name, member_cost, guest_cost, initial_outlay, monthly_maintenance) values
...
insert into members (id, last_name, first_name, address, zip, telephone, recommended_by, join_date) values
...
insert into bookings (id, facility_id, member_id, start_time, slots) values
